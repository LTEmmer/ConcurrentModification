# Generated by Django 5.1.7 on 2025-05-05 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('card_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='concurrent_modification.accounts')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('loan_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='concurrent_modification.accounts')),
            ],
            options={
                'db_table': 'loans',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_username', models.ForeignKey(blank=True, db_column='address_username', null=True, on_delete=django.db.models.deletion.CASCADE, to='concurrent_modification.personaldetails')),
            ],
            options={
                'db_table': 'addresses',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acct', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='concurrent_modification.accounts')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid', models.IntegerField()),
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('overdraft_transaction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='concurrent_modification.transactions')),
            ],
            options={
                'db_table': 'overdrafts',
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='details_username', null=True, on_delete=django.db.models.deletion.CASCADE, to='concurrent_modification.users', to_field='username'),
        ),
        migrations.CreateModel(
            name='HelpTickets',
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('ticket_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='concurrent_modification.users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='concurrent_modification.users')),
            ],
            options={
                'db_table': 'admins',
            },
